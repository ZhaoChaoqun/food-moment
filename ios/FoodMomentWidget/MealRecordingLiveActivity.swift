...
final class LiveActivityManager {
    ...
    private static let logger = Logger(subsystem: "com.foodmoment", category: "LiveActivityManager")
    ...
    func startMealRecording(
        ...
        guard ActivityAuthorizationInfo().areActivitiesEnabled else {
            Self.logger.warning("[LiveActivity] Live Activities not enabled")
            return
        }
        ...
        do {
            ...
            Self.logger.debug("[LiveActivity] Started meal recording activity: \(activity.id, privacy: .public)")
        } catch {
            Self.logger.error("[LiveActivity] Failed to start activity: \(error.localizedDescription, privacy: .public)")
        }
    }
