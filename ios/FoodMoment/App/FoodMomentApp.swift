...
extension FoodMomentApp {
    ...
    private func setupApp() async {
        // UI 测试模式下跳过大部分初始化
        if Self.isUITesting {
            Self.logger.debug("[App] Running in UI testing mode")
        ...
        do {
            ...
            Self.logger.error("[App] Notification authorization failed: \(error.localizedDescription, privacy: .public)")
        }
        ...
        do {
            ...
            Self.logger.error("[App] HealthKit authorization failed: \(error.localizedDescription, privacy: .public)")
        }
...
extension FoodMomentApp {
    ...
    private func handleDeepLink(_ url: URL) {
        ...
        let action = url.host ?? ""
        Self.logger.debug("[App] Handling deep link: \(action, privacy: .public)")
...
extension FoodMomentApp {
    ...
    private func handleSpotlightActivity(_ activity: NSUserActivity) {
        ...
        Self.logger.debug("[App] Spotlight activity: \(identifier, privacy: .public)")
